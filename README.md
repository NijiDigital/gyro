...
DBGenerator is a tool that generates Realm.io classes, for both Android and iOS, from a `.xcdatamodel` file.
...
## What is xcdatamodel
The `.xcdatamodel` is an XML file, generated by [Xcode](https://en.wikipedia.org/wiki/Xcode). It encodes the CoreData entities and can be created or edited in a graphical user interface.

![Simple Entity](documentation/simple_entity.png)

This `.xcdatamodel` is the input of the script.
